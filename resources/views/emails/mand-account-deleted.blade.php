{{--
    FILE:    resources/views/emails/mand-account-deleted.blade.php
    VERSION: 1.0.0
    DATE:    2026-06-29
    ...
    DATA FROM MAILABLE (MandAccountDeletedMail):
...
<head>
    ...
    <title>Ihr Galerist:innen-Konto wurde gelöscht</title>
    <style>
        body {
