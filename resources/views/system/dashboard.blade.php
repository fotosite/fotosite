            ...
            <a href="{{ route('system.users.index') }}"
               class="group relative flex flex-col gap-5 rounded-xl
                    ...
                    <svg class="w-[18px] h-[18px] text-gray-500"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round"
                              d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0
                                 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15
                                 ...
                                 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1
                                 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 leading-relaxed">
                        System-User einladen, Passwort-Reset, löschen
                    </p>
                </div>
