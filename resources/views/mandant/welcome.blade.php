{{--
    FILE:    resources/views/mandant/welcome.blade.php
    VERSION: 1.0.0
    DATE:    2026-06-20

    DESCRIPTION:
      Blockierende Willkommensseite für Galerist:innen (mand) — wird beim
      ersten Login angezeigt (mand_user.show_welcome = 1). Standalone (kein
      Dashboard-Nav), Stil wie policy/mand_update.blade.php. Markdown-Inhalt
      aus storage/app/private/willkommen_mand.md, von WelcomeScreenController
    ...
    ROUTES USED:
      POST mandant.welcome.confirm — Bestätigung absenden ("Gelesen")
...
<body class="min-h-screen bg-gray-50 text-gray-900 antialiased">
    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-12">
        <div class="w-full max-w-2xl bg-white rounded-xl border border-gray-200
            ...
            <form method="POST" action="{{ route('mandant.welcome.confirm') }}" class="border-t border-gray-100 pt-6 mt-2">
                @csrf
                <button type="submit"
