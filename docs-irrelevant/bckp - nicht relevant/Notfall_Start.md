...
| Einzige echte FK | activity_subgroup.ag_id -> activity_group.ag_id (fotodb). Alle anderen: logisch, kein FK-Constraint. |
...
# 5. Aktueller Projektstand (20.06.2026)
...
| Geltungsbereich | mand UND cust - Passkey ist PFLICHT, nicht optional |
...
Fotosite V08 — Notfall-Startdokument  |  Stand 21.06.2026  |  Seite